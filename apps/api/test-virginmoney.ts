// Quick parser test: reads a Virgin Money PDF, runs full pipeline, saves Excel output.
...
if (!filePath) { console.error('Usage: npx tsx test-virginmoney.ts <path-to-pdf>'); process.exit(1); }
